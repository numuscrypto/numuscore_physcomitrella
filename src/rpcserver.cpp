...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Numus features */
        {"numus", "masternode", &masternode, true, true, false},
        {"numus", "listmasternodes", &listmasternodes, true, true, false},
        {"numus", "getmasternodecount", &getmasternodecount, true, true, false},
        {"numus", "masternodeconnect", &masternodeconnect, true, true, false},
        {"numus", "masternodecurrent", &masternodecurrent, true, true, false},
        {"numus", "masternodedebug", &masternodedebug, true, true, false},
        {"numus", "startmasternode", &startmasternode, true, true, false},
        {"numus", "createmasternodekey", &createmasternodekey, true, true, false},
        {"numus", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"numus", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"numus", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"numus", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"numus", "getmasternodescores", &getmasternodescores, true, true, false},
        {"numus", "mnbudget", &mnbudget, true, true, false},
        {"numus", "preparebudget", &preparebudget, true, true, false},
        {"numus", "submitbudget", &submitbudget, true, true, false},
        {"numus", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"numus", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"numus", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"numus", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"numus", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"numus", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"numus", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"numus", "checkbudgets", &checkbudgets, true, true, false},
        {"numus", "mnsync", &mnsync, true, true, false},
        {"numus", "spork", &spork, true, true, false},
        {"numus", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"numus", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use numusd, or the -server option to numus-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> numus-cli " + methodname + " " + args + "\n";
}
