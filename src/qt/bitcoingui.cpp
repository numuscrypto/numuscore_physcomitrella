                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NUMUS Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NUMUS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and numus: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NUMUS Core"), this);
    aboutAction->setStatusTip(tr("Show information about NUMUS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NUMUS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NUMUS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NUMUS addresses"));
    ...
    openAction->setStatusTip(tr("Open a NUMUS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NUMUS Core help message to get a list with possible NUMUS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NUMUS Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NUMUS network", "", count));
}
...
{
    QString strTitle = tr("NUMUS Core"); // default title
