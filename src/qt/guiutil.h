...
/** Utility functions used by the NUMUS Qt UI.
 */
namespace GUIUtil
{
...
// Render NUMUS addresses in monospace font
...
// Parse "numus:" URI into recipient object, return true on successful parsing
